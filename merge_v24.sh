...
qiime feature-table merge --i-tables Illumina_V2_single/table_Illumina_V2_single.qza --i-tables Illumina_V4/table_Illumina_V4_03_09_2020.qza --o-merged-table insertion-V24-table_${dates}.qza
#download silva tree
